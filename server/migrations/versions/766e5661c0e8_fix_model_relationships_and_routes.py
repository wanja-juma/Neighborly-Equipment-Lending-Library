"""fix model relationships and routes

Revision ID: 766e5661c0e8
Revises: d38d2c9a1f56
Create Date: 2026-08-29 12:28:56.385449
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['equipment_id'], ['items.id'], ),
